 ...
 * @method #classnameModelUpSelect up()
 * ...
...
class #classnameModel extends dataModel{
	...
	*/
    ...
    protected $_upclass  = #classnameModelUpSelect::class;
}
/**
#variables
*/
 ...
 * @method mixed exec()
 * @method #classnameModelUpSelect where()
#upmethods */
class #classnameModelUpSelect extends CallbackBase {
    use UpMethods;
}
